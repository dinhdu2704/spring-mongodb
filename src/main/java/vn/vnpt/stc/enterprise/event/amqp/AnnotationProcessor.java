...
public class AnnotationProcessor {
    ...
    public static List<AMQPSubscriber> findSubscribers() {
        ...
        Reflections reflections = new Reflections(new ConfigurationBuilder()
                .setUrls(ClasspathHelper.forPackage("vn.vnpt"))
        ...
        for (Method m : annontated) {
            ...
            if (subscribes != null) {
                ...
                subscribers.add(new AMQPSubscriber(subscribes.queue(), subscribes.routingKey(), subscribes.exchange(), m.getDeclaringClass(), m, eventType, subscribes.concurrency()));
